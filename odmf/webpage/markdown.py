...
class ODMFExtension(markdown.Extension):
    def extendMarkdown(self, md: markdown.Markdown) -> None:
        ...
        md.inlinePatterns.register(PatternLink(md, r'(ds:)([0-9]+)', r'/dataset/\3/', r'!fa-clipboard \3'), 'link ds', 100)
        ...
        md.inlinePatterns.register(PatternLink(md, r'(project:)([0-9]+)', r'/project/\3', r'!fa-people-line \3'), 'link project', 100)
        ...
        md.inlinePatterns.register(PatternLink(md, r'(add-record:)([0-9]+).\"(.*?)\"', r'/dataset/add-record/\3', r'!fa-circle-plus \4'), 'add record', 100)
